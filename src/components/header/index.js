    ...
    <header className="header" ref={refHeader}>
      <div className="grid wide">
        <div className="row header__row">
          ...
          <div className="header__navbar-mobile"></div>
          <div className="header__action">
            ...
            <span className="header__action--setting">
              <ul
                ...
                className={
                  !isShowActionList
                    ? "header__action--setting--list"
                    : "header__action--setting--list show"
                }
              >
                ...
                <li className="header__action--setting--item">
                  <i className="fas fa-registered"></i>Register Account
                </li>
                <li className="header__action--setting--item">
                  <i className="fas fa-check-circle"></i>Check Out
                </li>
                <li className="header__action--setting--item">
              ...
              <img
                ...
                src="https://cdn.shopify.com/s/files/1/0328/1597/2488/t/22/assets/icon-account.png?v=14467188443966889471"
                alt=""
              />
            </span>
            <span className="header__action--cart">
              <div
                onClick={handelShowListCart}
                className="header__action--cart--icon"
              >
                <img
                  src="https://cdn.shopify.com/s/files/1/0328/1597/2488/t/22/assets/icon-cart-header.png?v=17649940948160480693"
                  alt=""
                />
                <span className="header__action--cart--total">
                  {carts.length}
                </span>
              </div>
              <ul
                  ...
                  {carts.map((item, index) => {
                    return (
                      <li key={index} className="header__action--cart--item">
                        ...
                        <div className="header__action--cart--content">
                          ...
                          <div className="header__action--cart--price">
                            ...
                            {item.product.price
                              .toFixed(2)
                              .replace(/\d(?=(\d{3})+\.)/g, "$&,")}
                            <span className="header__action--cart--qty">
                              {" "}
                              x {item.qty}
                            </span>
                          </div>
                        ...
                        <span
                          className="header__action--cart--remove"
                          onClick={() => handelRemoveCart(dispatch, index)}
                        >
