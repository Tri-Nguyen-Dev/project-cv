        ...
        <div className="row">
          <div className="col l-3">
            <div className="footer__about">
              <h3>ABOUT US</h3>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipis cing elit. Cras
                convallis, eros non finibus imperdiet ipsum mi posuere diam, nec
                imperdiet arcu urna et est. Curabitur feugiat lobortis sempe
              </p>
              <ul className="footer__content">
                <li>
                  <i className="fas fa-phone-volume"></i>
                  <span>0396675768</span>
                </li>
                <li>
